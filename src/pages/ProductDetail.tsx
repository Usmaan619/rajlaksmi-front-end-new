            ...
            <div className="space-y-5">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  {currentDelPrice > currentPrice && (
                    <>
                      ...
                      {currentDiscount > 0 && (
                        <Badge className="bg-red-50 text-red-600 border border-red-200 text-sm px-4 py-2 rounded-md font-bold hover:bg-red-100 transition-colors">
              ...
              <div className="pt-2">
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 h-12 bg-[#25D366] text-white font-bold rounded-xl hover:bg-[#128C7E] transition-all duration-300 shadow-md transform hover:-translate-y-1"
                >
                  <svg
