      ...
      <div className="min-h-screen bg-white">
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="space-y-5 text-center lg:text-left">
                ...
                <p className="text-foreground/80 text-sm sm:text-base leading-relaxed max-w-xl mx-auto lg:mx-0">
                  At Rajlakshmi Javiks, we believe that purity and quality
                  should not just be claimed — they should be proven. Our lab
                  testing process ensures that every product you consume is
                  safe, hygienic, and meets established quality standards.
                </p>
                ...
                <div className="pt-2">
                  <Button
                    aria-label="Read more about our testing process"
                    variant="outline"
        ...
        >
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            >
              Only products that meet our internal quality standards are
              released for sale.
            </p>
          </div>
        </section>
              ...
              <div className="space-y-6 text-center lg:text-left">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-foreground/80 text-sm sm:text-base leading-relaxed">
                    ...
                    national and international agencies, including the Food
                    Safety and Standards Authority of India (FSSAI). Additional
                    batch certifications align with global quality and organic
