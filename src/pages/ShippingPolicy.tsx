...
const ShippingPolicy = () => {
  return (
    <>
      <Seo 
        title="Shipping Policy | Rajlakshmi Javiks International"
        description="Learn about Rajlakshmi Javiks International's shipping methods, costs, and delivery times."
        url="/shipping"
      />
